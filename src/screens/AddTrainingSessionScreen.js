    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.formRow}>
          ...
          <View style={styles.inputGroup}>
            <Text style={styles.inputLabel}>What did you work on the most?</Text>
            <Text style={styles.inputHint}>Select one or more focus areas</Text>
            <View style={styles.trainingFocusSelector}>
              {trainingFocusOptions.map((option) => {
                ...
                return (
                  ...
                  >
                    <Text style={styles.trainingFocusOptionEmoji}>{option.emoji}</Text>
                    <Text style={[
                      styles.trainingFocusOptionLabel,
