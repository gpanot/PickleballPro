...
const styles = StyleSheet.create({
  ...
  coachFilterOptionActive: {
    backgroundColor: '#F0F9FF',
  },
  coachFilterOptionText: {
    fontSize: 14,
    color: '#374151',
  },
  coachFilterOptionTextActive: {
    color: '#0369A1',
    fontWeight: '600',
  },
  coachFilterClearButton: {
    marginTop: 4,
    marginHorizontal: 10,
    marginBottom: 4,
    paddingVertical: 10,
  ...
  // My Academy identity card (read-only header)
  myAcademyIdentityRow: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 14,
  },
  ...
  myAcademyRoyaltyBadge: {
    paddingHorizontal: 8,
    paddingVertical: 3,
    borderRadius: 10,
    backgroundColor: '#EDE9FE',
  },
  myAcademyRoyaltyText: {
    fontSize: 12,
    fontWeight: '700',
    color: '#7C3AED',
  },
  ...
  academyAddBtn: {
    alignSelf: screenWidth < 768 ? 'stretch' : 'flex-end',
    marginTop: screenWidth < 768 ? 4 : 18,
  },

  // Add member / invite row
  academyAddMemberRow: {
    flexDirection: 'row',
    alignItems: 'flex-start',
    gap: 12,
  ...
  academyFeedbackError: {
    color: '#EF4444',
    fontSize: 13,
  },
  academyFeedbackSuccess: {
    color: '#10B981',
    fontSize: 13,
  },
  academyHintText: {
  ...
  academyInviteResultLabel: {
    fontSize: 12,
    fontWeight: '600',
    color: '#166534',
    marginBottom: 6,
  },
  academyInviteResultLink: {
    fontSize: 13,
    color: '#15803D',
  ...
  academyMemberCardHeader: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 10,
    marginBottom: 8,
  },
  academyMemberCardFooter: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
  },
  ...
  adminEditModalRateRow: {
    flexDirection: 'row',
    gap: 10,
    marginBottom: 4,
  },
  adminEditModalRateChip: {
    flex: 1,
    minWidth: 0,
    paddingVertical: 14,
    borderRadius: 10,
  ...
  adminEditModalRateChipActive: {
    borderColor: '#7C3AED',
    backgroundColor: '#EDE9FE',
  },
  adminEditModalRateText: {
    fontSize: 18,
    fontWeight: '800',
    color: '#374151',
  },
  adminEditModalRateTextActive: {
    color: '#7C3AED',
  },
  adminEditModalRateHint: {
    fontSize: 10,
    fontWeight: '600',
    color: '#9CA3AF',
    marginTop: 2,
  },
  adminEditModalSaveBtn: {
  ...
  adminEditModalSaveBtnText: {
    fontSize: 15,
    fontWeight: '700',
    color: '#FFFFFF',
  },

  // ── My Academy redesign — Overview / Members / Students tabs ──────────────

  // Academy page header (logo + name + pencil, always visible above tabs)
  academyPageHeader: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'space-between',
  ...
  // Sub-tabs (Overview / Members / Students)
  academySubTabBar: {
    flexDirection: 'row',
    borderBottomWidth: 1,
  ...
  academySubTabTextActive: {
    color: '#007AFF',
    fontWeight: '700',
  },

  // Revenue hero (big black card)
  academyRevenueHero: {
    backgroundColor: '#000000',
    borderRadius: 18,
    padding: screenWidth < 768 ? 20 : 28,
  ...
  academyRevenueBreakdownCol: {
    flex: 1,
    alignItems: 'center',
    paddingHorizontal: 4,
  },
  academyRevenueBreakdownVal: {
    fontSize: 22,
    fontWeight: '800',
    color: '#FFFFFF',
  },
  academyRevenueBreakdownLab: {
    fontSize: 11,
  ...
  // Projection box (right side of revenue hero)
  academyProjectionBox: {
  ...
  academyProjectionLabel: {
    fontSize: 11,
    fontWeight: '700',
    color: 'rgba(255,255,255,0.4)',
    marginBottom: 6,
  },
  academyProjectionTarget: {
    fontSize: 13,
    fontWeight: '800',
    color: '#FFFFFF',
    marginBottom: 12,
  },
  academyProjectionTrack: {
    height: 6,
  ...
  academyProjectionFill: {
    height: '100%',
    borderRadius: 100,
    backgroundColor: '#007AFF',
  },
  academyProjectionNote: {
    fontSize: 11,
  ...
  academyInviteNudgeTitle: {
    fontSize: 14,
    fontWeight: '800',
    color: '#000000',
  },
  academyInviteNudgeSub: {
    fontSize: 13,
    color: '#666666',
    marginTop: 2,
  },

  // Overview stats row (3-col grid)
  academyOverviewStatGrid: {
    flexDirection: screenWidth < 768 ? 'column' : 'row',
    gap: 12,
    marginBottom: 24,
  },
  academyOverviewStatCard: {
    flex: 1,
    backgroundColor: '#FFFFFF',
    borderRadius: 14,
    borderWidth: 1,
  ...
  academyOverviewStatVal: {
    fontSize: 26,
    fontWeight: '900',
    color: '#000000',
    letterSpacing: -0.5,
  },
  academyOverviewStatLabel: {
    fontSize: 12,
    color: '#999999',
    marginTop: 3,
    fontWeight: '600',
  },
  academyOverviewStatDelta: {
    fontSize: 12,
    fontWeight: '700',
    marginTop: 6,
  },
  academyOverviewSectionTitle: {
    fontSize: 15,
    fontWeight: '800',
    color: '#000000',
  },
  academyOverviewSectionLink: {
    fontSize: 13,
    fontWeight: '700',
    color: '#007AFF',
    ...(Platform.OS === 'web' && { cursor: 'pointer' }),
  ...
  // Royalties by coach table
  academyRoyaltiesTable: {
    backgroundColor: '#FFFFFF',
    borderRadius: 14,
    borderWidth: 1,
    borderColor: '#E5E5E5',
  ...
  academyRoyaltiesAvatarText: {
    fontSize: 13,
    fontWeight: '800',
    color: '#666666',
  },
  academyRoyaltiesCoachName: {
    fontSize: 14,
    fontWeight: '700',
    color: '#000000',
  },
  academyRoyaltiesCoachSub: {
    fontSize: 12,
    color: '#999999',
    marginTop: 1,
  },
  academyRoyaltiesCellVal: {
    fontSize: 14,
    fontWeight: '600',
    color: '#000000',
  },
  academyRoyaltiesCellSub: {
    fontSize: 12,
    color: '#999999',
  },
  academyStatusBadgeActive: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 4,
    paddingHorizontal: 8,
  ...
  academyStatusBadgeActiveText: {
    fontSize: 11,
    fontWeight: '700',
    color: '#16a34a',
  },
  academyStatusBadgePending: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 4,
    paddingHorizontal: 8,
  ...
  academyRoyaltiesEmpty: {
    paddingVertical: 40,
    paddingHorizontal: 24,
    alignItems: 'center',
  },
  academyRoyaltiesEmptyTitle: {
    fontSize: 14,
    fontWeight: '700',
    color: '#000000',
    marginTop: 12,
  },
  academyRoyaltiesEmptySub: {
    fontSize: 13,
    color: '#666666',
    marginTop: 4,
    textAlign: 'center',
  ...
  // Small button (primary — used in nudge + empty states)
  academyBtnSmPrimary: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 5,
  ...
  academyBtnSmOutlineText: {
    fontSize: 13,
    fontWeight: '700',
    color: '#000000',
  },

  // Members 2-col grid (web only)
  academyMembersGrid: {
    flexDirection: 'row',
    gap: 20,
    marginBottom: 24,
  ...
  academyMembersGridCol: {
    flex: 1,
    minWidth: 0,
  },

  // Invite link preview (Members tab)
  academyInviteLinkPreview: {
    backgroundColor: '#F8F9FA',
    borderWidth: 1,
    borderColor: '#E5E5E5',
    borderRadius: 9,
